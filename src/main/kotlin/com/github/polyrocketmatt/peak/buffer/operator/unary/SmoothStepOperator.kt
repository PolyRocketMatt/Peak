...
class SmoothStepOperator : UnaryBufferOperator {
     ...
     */
    override fun operate(buffer: SyncNoiseBuffer2, vararg data: Float): SyncNoiseBuffer2 = buffer.map { fl -> fl.smoothStep() }
     ...
     * @return a new NoiseBuffer that contains the smoother-stepped elements of the buffer
     */
    override fun operate(buffer: SyncNoiseBuffer3, vararg data: Float): SyncNoiseBuffer3 = buffer.map { fl -> fl.smoothStep() }
